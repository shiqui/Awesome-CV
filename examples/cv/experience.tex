...
{May. 2024 - Aug. 2024} % Date(s)
{
  \begin{cvitems} % Description(s) of tasks/responsibilities
    \item {Applied \textbf{Simulated Annealing Search} to perform schedule optimization, where a discrete space of permutated schedules is searched. Improved the metrics by approximately \textbf{20\%}, by reducing search space, improving neighbor selection, and tuning cost function.}
